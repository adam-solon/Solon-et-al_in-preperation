...
subtitle: "  \n Normalization and/or Transformation of 16S DNA-seq Data"
author: "Adam J. Solon"
date: "`r Sys.Date()`"
...
# Script Summary  
This script applies standard normalization and transformation of 16S SSU rRNA gene sequencing data to account for differences in library size (i.e., read depth) that confound downstream analyses.
...
asvTable.fp <- paste0(sub.directory.2.1.1.1.1.fp, "/MDV-nurtient-limitation-soils-ASv-tab-16s.txt") 
...
phy.r <- rarefy_even_depth(phy, 
                           sample.size = 11186, #no. of reads for cut-off, number is generated from 'raremax' object above
...
```{r save files}
# save as an R file 
saveRDS(df.u.3, paste0(sub.directory.2.1.1.1.2.fp, "/m.rich.16s.rds"))

#save as .txt file 
write.table(df.u.3, file = paste0(sub.directory.2.1.1.1.2.fp, "/MDV-nutrient-limitation-soils-richness-16s.txt"), 
